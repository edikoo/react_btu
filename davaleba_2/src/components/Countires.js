            ...
            <div className="mb-30" >
                ...
                <div className="input-group mb-3">
                    <div className="input-group-prepend">
                        <span className="input-group-text" id="basic-addon1">შეიყვანეთ ქვეყნების რაოდენობა</span>
                    </div>
                    <input type="text" className="form-control" onChange={e => setQuantity(e.target.value)} placeholder="რაოდენობა" />
                </div>
                <input type="text" placeholder="სახელით გაფილტვრა" onChange={filterList} className="form-control filter"  />
                <br /><br />
